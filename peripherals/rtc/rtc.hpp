...
namespace xmcu {
namespace soc {
template<> class Scoped_guard<m4::stm32wb::rm0434::peripherals::backup_domain> : public Non_copyable
{
public:
    Scoped_guard()
    {
...
template<> class Scoped_guard<m4::stm32wb::rm0434::peripherals::rtc> : private Non_copyable
{
public:
    Scoped_guard()
    {
...
private:
    Scoped_guard<m4::stm32wb::rm0434::peripherals::backup_domain> bd_guard; // Must be unlocked prior to unlocking RTC
};
