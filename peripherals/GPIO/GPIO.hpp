...
public:
    ...
    explicit operator xmcu::soc::m4::wb::rm0434::peripherals::ll::gpio::Port*()
    {
...
private:
    ...
    std::uint32_t idx;
    xmcu::soc::m4::wb::rm0434::peripherals::ll::gpio::Port *p_registers;
...
template<> class peripheral<m4::wb::rm0434::peripherals::GPIO, 1u> : private non_constructible
{
public:
    static m4::wb::rm0434::peripherals::GPIO create()
    {
        namespace wb_peripherals = m4::wb::rm0434::peripherals;
        return m4::wb::rm0434::peripherals::GPIO(0u, wb_peripherals::ll::gpio::port<wb_peripherals::ll::gpio::A>());
    }
};
#endif

#if defined(XMCU_GPIOB_PRESENT)
template<> class peripheral<m4::wb::rm0434::peripherals::GPIO, 2u> : private non_constructible
{
public:
    static m4::wb::rm0434::peripherals::GPIO create()
    {
        namespace wb_peripherals = m4::wb::rm0434::peripherals;
        return m4::wb::rm0434::peripherals::GPIO(1u, wb_peripherals::ll::gpio::port<wb_peripherals::ll::gpio::B>());
    }
};
#endif

#if defined(XMCU_GPIOC_PRESENT)
template<> class peripheral<m4::wb::rm0434::peripherals::GPIO, 3u> : private non_constructible
{
public:
    static m4::wb::rm0434::peripherals::GPIO create()
    {
        namespace wb_peripherals = m4::wb::rm0434::peripherals;
        return m4::wb::rm0434::peripherals::GPIO(2u, wb_peripherals::ll::gpio::port<wb_peripherals::ll::gpio::C>());
    }
};
#endif

#if defined(XMCU_GPIOD_PRESENT)
template<> class peripheral<m4::wb::rm0434::peripherals::GPIO, 4u> : private non_constructible
{
public:
    static m4::wb::rm0434::peripherals::GPIO create()
    {
        namespace wb_peripherals = m4::wb::rm0434::peripherals;
        return m4::wb::rm0434::peripherals::GPIO(3u, wb_peripherals::ll::gpio::port<wb_peripherals::ll::gpio::D>());
    }
};
#endif

#if defined(XMCU_GPIOE_PRESENT)
template<> class peripheral<m4::wb::rm0434::peripherals::GPIO, 5u> : private non_constructible
{
public:
    static m4::wb::rm0434::peripherals::GPIO create()
    {
        namespace wb_peripherals = m4::wb::rm0434::peripherals;
        return m4::wb::rm0434::peripherals::GPIO(4u, wb_peripherals::ll::gpio::port<wb_peripherals::ll::gpio::E>());
    }
};
#endif

#if defined(XMCU_GPIOH_PRESENT)
template<> class peripheral<m4::wb::rm0434::peripherals::GPIO, 8u> : private non_constructible
{
public:
    static m4::wb::rm0434::peripherals::GPIO create()
    {
        namespace wb_peripherals = m4::wb::rm0434::peripherals;
        return m4::wb::rm0434::peripherals::GPIO(7u, wb_peripherals::ll::gpio::port<wb_peripherals::ll::gpio::H>());
    }
};
#endif
